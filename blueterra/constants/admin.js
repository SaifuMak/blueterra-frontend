export const SIDEBAR_ITEMS = [
    ...
    { icon: "/Icons/file.svg", name: "Categories", path: "/admin/catagories" },
    ...
    { icon: "/Icons/page.svg", name: "Cruise", path: "/admin/cruise" },

    // { icon: "/Icons/page.svg", name: "Pages", path: "/admin-pages" },
    { icon: "/Icons/journal.svg", name: "Journal", path: "/admin/journals" },
];
