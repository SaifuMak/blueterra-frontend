...
function PlanningSection({handleNavigateToContactForm}) {
    return (
        <div className=" xl:min-h-[45vh] md:min-h-[40vh] h-[45vh] w-full   relative ">
            ...
            <div className=" w-full max-sm:px-2  absolute inset-0 text-center space-y-4 lg:space-y-4 2xl:space-y-7   h-full text-dark-28  flex flex-col justify-center items-center">
                <h3 className={`${playfair.className} font-medium vertically-animated-element max-sm:px-2  md:w-10/12 text-dark-4B text-2xl md:text-4xl xl:text-[45px]  2xl:text-[50px]`}>Planning an event that should inspire, connect and deliver results? </h3>
