...
function InfoCards({ data }) {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-20 h-full w-full flex flex-col items-center  rounded-2xl justify-center  transition-all duration-1000 ease-in-out group-hover:bg-black/40 group-hover:text-white text-center xl:text-lg 2xl:text-xl font-light px-4 2xl:px-8">
