            ...
            <div className="2xl:w-11/12  lg:w-full  w-11/12 max-sm:mt-10  max-lg:space-y-10  lg:space-x-10 flex flex-col items-center  ">
                ...
                <div className=" flex  max-lg:flex-col w-full lg:justify-center max-sm:space-y-8 ">
                    ...
                    <div className="lg:w-4/12    w-full flex flex-col max-sm:pl-3  xl:space-y-6 2xl:space-y-8 ">
                        ...
                        {CONTACT_DETAILS?.map((data, index) => (
                            <div key={index} className=" flex items-center font-light space-x-3 xl:space-x-5">
                                <img src={data.icon} alt="search icon " className=" object-cover shrink-0 size-7 lg:size-8 xl:size-8" />
                                <div className=" text-lg xl:text-lg max-sm:text-base ">
                                    <p className=" font-normal">{data.title}</p>
                                    <p className=" opacity-90 mt-1  ">{data.details}</p>
                        ...
                        <div className="vertically-animated-element  lg:ml-4 lg:space-y-4 max-sm:space-y-3 space-y-5 xl:space-y-6 max-sm:mt-6 mt-2">
                            {CONTACT_DETAILS?.map((data, index) => {
                    ...
                    <div className="lg:w-6/12    w-full  h-full overflow-hidden  ">
                        <div className="w-full max-sm:h-[600px]    sm:h-[400px] lg:h-[400px] xl:h-[420px] 2xl:h-[420px] ">
                            <iframe
                                title="Zoho Form"
