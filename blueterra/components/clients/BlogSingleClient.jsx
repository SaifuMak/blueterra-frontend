    ...
    return (
        ...
        <SmoothScroll>
            ...
            <div className={` ${rubik.className} w-full text-dark-28 h-full flex flex-col justify-center items-center relative`} >
                ...
                {relatedBlogs.length > 0 && <div className=" w-11/12 max-sm:-mt-4  mb-10  rounded-3xl py-8 md:py-12 lg:py-16 xl:py-12 overflow-hidden flex justify-center  items-center bg-sky-blue-light  h-full   relative  ">
