            ...
            <div className={` ${rubik.className} w-full text-dark-28 h-full flex flex-col justify-center items-center relative`} >
                ...
                <div className=" w-11/12 2xl:w-10/12 mt-10 md:mt-20  mb-10 flex max-lg:flex-col   ">
                    ...
                    <div className=" w-full lg:w-6/12 xl:w-5/12 py-5 space-y-10 h-full lg:border-l lg:px-4 2xl:px-10 ">
                        ...
                        <div className=" w-full 2xl:h-[380px] lg:h-[390px] h-[400px] rounded-2xl overflow-hidden relative">
                            <Image
                                src='/images/blog-single/mountain-in-sea.png'
                                alt='beach'
                                fill
                            ...
                            <div className=" w-full h-full flex items-end  bg-gradient-to-t from-black via-black/30 to-transparent  absolute inset-0">
                                <div className=" flex flex-col p-5 flex-center  w-full space-y-3">
                                    <h3 className={` xl:pr-7 text-lg max-sm:text-center   text-white ${playfair.className}`}>Turning your travel dreams into real Adventures.</h3>
                ...
                {relatedBlogs.length > 0 && <div className=" w-11/12 max-sm:-mt-4  mb-10  rounded-3xl py-8 md:py-12 lg:py-16 xl:py-20 overflow-hidden flex justify-center  items-center bg-sky-blue-light  h-full   relative  ">
                    ...
                    <div className=" xl:w-10/12  w-11/12  max-sm:w-10/12 h-full">
                        <h2 className={`${playfair.className}  text-2xl md:text-3xl  font-semibold text-dark-4B`}>Related Posts</h2>
