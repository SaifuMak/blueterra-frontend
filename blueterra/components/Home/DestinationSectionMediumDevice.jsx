...
function DestinationSectionMediumDevice() {
    ...
    useEffect(() => {
        ...
        tl.to(
            ".title-slider",
            { y: -currentIndex * 120, duration: 0.8, ease: "power3.inOut" },
            "<0.2"
        );
        tl.to(
            ".desc-slider",
            { y: -currentIndex * 140, duration: 0.8, ease: "power3.inOut" },
            "<"
        );
    ...
    return (
        <>
            {slides?.length > 1 && (<div className="min-h-[100vh] w-full relative overflow-hidden">
                ...
                <div className="max-w-11/12 mx-auto  ">
                    ...
                    <div className=" w-full vertically-animated-element text-white relative  py-20   ">
                        <h3 className={` ${playfair.className}  text-[45px] xl:text-[50px]`}>Our Destination Highlights</h3>
                    ...
                    <div className=" w-full  mx-auto items-center  py-5 grid grid-cols-12 ">
                            ...
                            <div className="h-[120px]   overflow-hidden">
                                <div className="title-slider">
                                    {slides.map((slide, idx) => (
                                        ...
                                        >
                                            <h2 className={`xl:text-7xl text-5xl font-medium    text-white ${playfair.className}`}>
                                ...
                                <div className="desc-slider">
                                    {slides.map((slide, idx) => (
                                        <div
                                            ...
                                            className="h-[140px] flex items-center"
                                        >
                        ...
                        <div className=" col-span-8 relative w-full overflow-hidden py-12 ml-7 2xl:ml-20 ">
                            <div ref={containerRef} className="flex w-full">
                                {slides.map((slide, index) => (
                                    <div
                                        key={slide.id + "-" + index}
                                        className="w-1/2 flex-shrink-0 cursor-pointer px-2 2xl:px-5"
                                        onClick={() => handleClick(index)}
                                    >
                                        <div
                                            ref={(el) => (cardsRef.current[index] = el)}
                                            className="carousel-card h-[320px] rounded-2xl shadow-xl overflow-hidden relative"
                                        >
                                            <img
...
export default DestinationSectionMediumDevice