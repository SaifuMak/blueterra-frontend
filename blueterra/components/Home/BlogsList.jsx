...
export default function BlogsList({ Data, setCurrent, setCount, onclickEvent = () => { } }) {
                    ...
                    <CarouselContent>
                        ...
                        {Data?.map((item, index) => (
                            <CarouselItem key={index} className="md:basis-1/2   2xl:p-3 pb-2 lg:basis-1/3  mx-0  flex-center  ">
                                <div onClick={()=>onclickEvent(item.slug)} className=" relative group aspect-[47/50]  cursor-pointer w-[370px]  xl:w-[470px] 2xl:h-[600px] xl:h-[500px] md:h-[480px] h-[410px] rounded-2xl overflow-hidden">

                                    <img src={item.image_public_url} alt={item.title} className="w-full h-full object-cover group-hover:scale-110 transition-all duration-1000 ease-in-out" />
                                    ...
                                    <div className="absolute inset-0 group">
                                        ...
                                        <div className="flex items-end absolute inset-0   z-10">
                                            <div className="py-6 bg-gradient-to-t  w-full from-black to-transparent  px-6 transform transition-transform duration-1000 group-hover:translate-y-0  md:min-h-64   text-white">
                                                <h6 className={` ${playfair.className} text-[20px] `}>{item.title}</h6>
