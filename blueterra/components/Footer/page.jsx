...
export default function Footer() {
    ...
    return (
        <div className={`  ${rubik.className}w-full flex justify-center  text-white text-sm font-light xl:text-base items-center bg-[#002846] `}>
            <div className="xl:w-10/12 w-full max-xl:px-8 py-10 xl:py-10  flex flex-col space-y-5">
                ...
                <div className=" flex justify-between max-lg:flex-col max-lg:space-y-5  py-5 xl:py-10 border-white/30 border-t border-b ">
                    ...
                    <div className=" ">
                        ...
                        <p className=" lg:ml-2 lg:w-56 mt-2 lg:mt-4  pr-5 ">We are a boutique, founder-led travel
                            brand based in the UAE, dedicated to
                            crafting thoughtful and personalized
                            journeys.</p>
                    </div>

                    <div className=" flex max-md:flex-col  2xl:space-x-16 xl:space-x-10 space-x-5  ">
                ...
                <div className=" flex max-md:flex-col max-md:space-y-2 items-center max-lg:text-xs justify-between">
                    <p className=""> <span className=" text-[#45A5FF]">©</span> 2025 BlueTerra All Rights Reserved.<a href="https://maktalseo.com/" target="_blank" rel="noopener noreferrer" className=" hover:cursor-pointer"> Design by MakTal</a></p>
