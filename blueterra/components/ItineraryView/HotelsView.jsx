...
export default function HotelsView({}) {
    ...
    return (
        <div className="lg:w-10/12 hotels-container md:w-11/12 w-full bg-white/5 backdrop-blur-md backdrop-filter md:space-y-6  space-y-4 2xl:px-20 xl:px-10 lg:px-20  md:py-10 py-5 z-10 ">
