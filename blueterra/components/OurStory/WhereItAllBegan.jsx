    ...
    return (
        <div className={`${rubik.className}   flex-center`}>
            <div className=" w-full font-light text-[15px] md:text-lg  xl:text-xl flex-center  text-white px-4  md:px-10 2xl:py-20 md:py-10 py-10  backdrop-blur-2xl border rounded-2xl  border-white/30 shadow-lg bg-black/0  ">
                <div className="flex flex-col items-center  w-full  xl:w-10/12 text-center space-y-2 lg:space-y-4">
                    <h2 className={`${playfair.className} font-light text-2xl md:text-5xl xl:text-[60px] max-sm:mb-4 2xl:text-[70px]`}>How it All Began</h2>
                    ...
                    <p className=" xl:leading-9 leading-6 md:leading-8 2xl:leading-10 lg:px-10 text-white/90">To us travel is not just about where you go. It is about how it moves you, changes you, and the way you carry it with you when you return home. </p>
                    <p className="xl:leading-9 leading-6 md:leading-8 2xl:leading-10 lg:px-10 text-white/90">Welcome to BlueTerra Travel and Experiences.</p>
                    <p className=" xl:leading-9 leading-6 md:leading-8 2xl:leading-8 lg:px-10 text-white/90">Let us create your next story together.</p>
