...
export default function JourneryIntro() {
    ...
    return (
        <div className=" relative py-10  lg:py-16  flex-center md:px-10 px-3   bg-white w-full h-full ">

            <div className=" py-10  2xl:py-7   w-full items-center max-md:space-y-5 max-sm:px-3 max-sm:py-7 max-sm:pt-12 md:space-x-10    justify-center rounded-4xl bg-[#F4FBFF] h-full md:flex   ">
