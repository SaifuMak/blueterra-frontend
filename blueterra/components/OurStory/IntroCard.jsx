...
export default function IntroCard() {
    ...
    return (
        <div className={`${rubik.className} text-center   lg:mt-20 text-white `} >
            ...
            <Button text='EXPLORE MORE' buttonStyle='translate-all mt-4 md:mt-7 xl:mt-12 duration-1000 ease-in-out  px-4 lg:px-8 xl:px-12 py-1.5 lg:py-2.5' onClickFunction={handleExploreClick} />
