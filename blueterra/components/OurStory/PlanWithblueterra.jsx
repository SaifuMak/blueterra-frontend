    ...
    return (
        <div className="  relative min-h-[45vh]  z-10 2xl:min-h-[50vh]">
            ...
            <div className=" absolute flex-center  2xl:py-6 space-y-5 flex-col inset-0  w-full h-full text-center ">
                <div ref={titleRef} className=" max-sm:px-8 ">
                    <TitleText text='Where Do You Dream of Going?' />
                </div>
                <p ref={descriptionRef} className=" text-lg xl:text-[22px] 2xl:text-2xl font-light max-w-2xl  px-3   max-lg:px-4  text-dark-28 xl:leading-10 ">Tell us what you long to experience, and we’ll bring it to life</p>
