    ...
    return (
        ...
        <div className="w-full relative min-h-screen  ">
            ...
            <div className=" w-full h-auto absolute bg-black/10  inset-0 flex-center flex-col text-white ">
                <div className="flex-center flex-col space-y-5 lg:space-y-8 mt-10  ">
                    ...
                    <div className=" max-w-11/12   border no-scroll-bar   max-lg:max-h-[80vh]  max-lg:h-full  max-lg:overflow-y-auto lg:max-w-10/12 sm:p-2 rounded-2xl "
