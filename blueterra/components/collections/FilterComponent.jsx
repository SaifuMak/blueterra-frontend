...
export default function FilterComponent({ name, options, handleFilters, isOpened, handleItemSelection, selectedFilters }) {
    ...
    return (
        <div className={`${isOpened ? 'bg-sky-blue-1 text-white border ' : ' text-dark-28 border border-[#BEBEBE]/80'} z-20  transition-all duration-500 ease-in-out    rounded-sm  cursor-pointer relative inline-block`}  >
