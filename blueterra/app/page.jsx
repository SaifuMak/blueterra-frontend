    ...
    <SmoothScroll>
      ...
      <div ref={welcomeContainerRef} className={`w-full h-full  `}>
        ...
        <div className="w-full relative  h-screen">
          ...
          <video ref={videoRef} src="https://cdn.myblueterra.com/Opening%20video_Home%20page_2.mp4"
          ...
          <div className={` w-full py-16 md:py-16 xl:py-24  bg-white  2xl:py-44 flex justify-center  text-center`}>
            <div ref={messageContainerRef} className={`${rubik.className}  md:px-10 px-10 text-dark-28  w-full lg:w-10/12  xl:w-8/12 space-y-6 2xl:space-y-8`}>
              ...
              <p className="2xl:text-xl lg:text-lg  text-sm  font-light leading-8 2xl:leading-10 lg:px-6  ">What began as a simple thought has grown into something far more meaningful.
                ...
                and journey we design is imagined with soul and crafted with care, so that when you return you carry not just memories but a new part of yourself. BlueTerra was created from passion and joy for those who believe travel can change us for the better.</p>
            ...
            <div className="   z-30  w-full h-fit  mt-10 max-md:hidden overflow-x-auto ">
              ...
              <div ref={testimonialContainer} style={{
                ...
                {extendedTestimonials?.map((testimonial, index) => (
                  <div key={index} ref={(el) => (cardRefs.current[index] = el)} className=" lg:min-w-[320px] min-w-[280px] overflow-hidden testimonial-card mx-5 lg:mx-10 z-20 bg-white   min-h-[50%]  px-5 lg:px-10 pt-10  pb-7 rounded-2xl " style={{ boxShadow: '0 0 25px 1px rgba(153, 189, 188, 0.3)', }}>
        ...
        <PartnerCompaniesSection isMobile={isMobile} />
